...
;           & Display Player 2 streak win message if streak counter reaches 5
CheckPlayer2Streak:
...
ConvertIntegerToStringLoop_Reversed:
  mov rdx, 0                                                                   ;Move the "0" value into "rdx" register (Prevent concatenation of "rax" and "rdx" register, act as a 128 Bit register together)
